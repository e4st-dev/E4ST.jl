...
base_out_path = joinpath(@__DIR__, "out/gurobi-sequential")
@time out_path, _ = run_e4st(config_2016, config_gurobi; base_out_path, iter = RunSequential(years=["y2025", "y2030"]))