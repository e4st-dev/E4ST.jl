...
function parse_power_results!(config, data)
    ...
    add_table_col!(data, :bus, :pflow_in, pflow_out_bus, MWFlow,"Average power flowing into this bus, positive")
    add_table_col!(data, :bus, :eflow_out, eflow_out_bus, MWhFlow,"Electricity flowing out of this bus, positive")
    add_table_col!(data, :bus, :eflow_in, eflow_out_bus, MWhFlow,"Electricity flowing into this bus, positive")
