...
function summarize_config()
    ...
    push!(df, 
        ...
        (:load_shape_file, false, nothing, "a file for specifying the hourly shape of demand elements.  See [`summarize_table(::Val{:load_shape})`](@ref)"),
        (:load_match_file, false, nothing, "a file for specifying annual demanded energy to match for sets.  See [`summarize_table(::Val{:load_match})`](@ref)"),
        (:load_add_file, false, nothing, "a file for specifying additional demanded energy, after matching.  See [`summarize_table(::Val{:load_add})`](@ref)"),
        (:load_add_file, false, nothing, "a file for specifying additional demanded energy, after matching.  See [`summarize_table(::Val{:load_add})`](@ref)"),
