...
Returns the total energy generation from a gen for the given year and hour. 

* To use this to retieve the variable values after the model has been optimized, wrap the function with value() like this: value.(get_egen_gen).
"""
